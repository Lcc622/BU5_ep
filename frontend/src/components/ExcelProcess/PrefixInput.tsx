...
export function PrefixInput() {
 ...
 <section className="rounded-[28px] border border-[#E8EAED] bg-white p-6 shadow-panel">
  ...
  <button
   ...
   className=" bg-aurora px-5 py-3 text-sm font-semibold text-white transition hover:opacity-90 disabled:opacity-40 disabled:cursor-not-allowed"
  >
   预生成 SKU
  </button>

  <div className=" bg-mist px-4 py-3 text-sm font-semibold text-ink">
