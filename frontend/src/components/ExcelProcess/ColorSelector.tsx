...
export function ColorSelector() {
 ...
 <section className="rounded-[28px] border border-[#E8EAED] bg-white p-6 shadow-panel">
  ...
  <div className="inline-flex bg-[#F7F9FA] p-1">
  ...
  {selected.length > 0 ? (
   ...
   <button
    ...
    className=" border border-ink bg-ink px-3 py-2 text-xs font-bold uppercase tracking-[0.16em] text-white"
   >
    {code}
  ...
  <div className="mt-6 border border-[#E8EAED]">
